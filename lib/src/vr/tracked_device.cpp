...
vr::TrackedDeviceClass QOverlay::VR::TrackedDevice::GetClass(QOverlay::VR::TrackedDevice::DeviceType deviceType) {
	switch (deviceType) {
	case QOverlay::VR::TrackedDevice::DeviceType::HMD:
		return vr::TrackedDeviceClass_HMD;
	case QOverlay::VR::TrackedDevice::DeviceType::ControllerAny:
		return vr::TrackedDeviceClass_Invalid;
	case QOverlay::VR::TrackedDevice::DeviceType::ControllerLeft:
	case QOverlay::VR::TrackedDevice::DeviceType::ControllerRight:
		return vr::TrackedDeviceClass_Controller;
	case QOverlay::VR::TrackedDevice::DeviceType::Tracker:
		return vr::TrackedDeviceClass_GenericTracker;
	case QOverlay::VR::TrackedDevice::DeviceType::TrackingReference:
...
vr::TrackedDeviceIndex_t QOverlay::VR::TrackedDevice::GetIndex(QOverlay::VR::TrackedDevice::DeviceType deviceType) {
	...
	const vr::ETrackedControllerRole controllerRole = GetControllerRole(deviceType);
...
vr::ETrackedControllerRole QOverlay::VR::TrackedDevice::GetControllerRole(QOverlay::VR::TrackedDevice::DeviceType deviceType) {
	switch (deviceType) {
	case QOverlay::VR::TrackedDevice::DeviceType::ControllerAny:
